...
<body>
    ...
    <div class="formcontainer">
        <form action="#" method="post" class="formbox" target="_parent">
            ...
            <input type="text" name="website" id="website" placeholder="Enter Your Website" value='Enter Website Name'>
    ...
    if (isset($_POST['website'])) {
        ...
        if ($row) {
            ...
            // echo "Data not Found!";
            echo "<script>";
            echo "document.getElementById('#msg).innerText = 'Record not found!';";
            echo "</script>";
        }
